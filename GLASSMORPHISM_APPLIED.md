...
- **Components:**
  ...
  - `GlassContainer` - Glass card container
  - `GlassInput` - Glass input field
...
1. **Complete Register Page:**
   - Convert all Input components to GlassInput
   - Update select dropdowns with glass styling
   - Update buttons to GlassButton
   - Update labels to white text
