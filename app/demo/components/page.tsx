...
export default function ComponentDemoPage() {
  ...
  const tabs = [
    { id: 'overview', label: 'Overview', icon: <BarChart3 className="h-4 w-4" />, href: '/demo/components' },
    { id: 'components', label: 'Components', icon: <Settings className="h-4 w-4" />, href: '/demo/components' },
    { id: 'data', label: 'Data Demo', icon: <Users className="h-4 w-4" />, href: '/demo/components' },
    { id: 'features', label: 'Features', icon: <Zap className="h-4 w-4" />, href: '/demo/components' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          {/* Enterprise Toolbar */}
          <EnterpriseToolbar title="Demo Management" />
