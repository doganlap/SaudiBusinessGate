  ...
  return (
    <div className={`container ${direction}`}>
      ...
      <header className={`${tw.ms(4)} ${tw.pe(4)} ${tw.textStart}`}>
        ...
        {/* Language switcher */}
        <div className={`flex ${tw.flexRow} gap-2`}>
          <button 
      ...
      >
        ...
        >
          ...
          <div className={`${tw.mt(4)} space-y-2`}>
          ...
          <div className={`flex ${tw.flexRow} ${tw.justifyEnd} gap-2 ${tw.mt(4)}`}>
        ...
        <ul className={`${tw.mt(6)} ${tw.textStart}`}>
        ...
        <nav className={`flex ${tw.flexRow} ${tw.justifyBetween} ${tw.mt(6)}`}>
          <button className={`flex items-center ${tw.flexRow}`}>
            <span className={tw.iconFlip}>←</span>
        ...
        <table className={`w-full ${tw.mt(6)}`}>
          <thead>
