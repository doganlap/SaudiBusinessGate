...
export default function ExampleComponent() {
  ...
  return (
    <div className={`container ${direction}`}>
      ...
      <main 
        className={`${tw.textStart} ${tw.ps('5')} ${tw.ms('3')}`}
      >
        {/* Card with RTL-aware layout */}
        <div 
          className={`card ${tw.borderStart} border-4 border-blue-500 ${tw.ps('4')} rounded-lg`}
        >
      ...
      <aside 
        className={`sidebar ${tw.borderStart} border border-gray-300 ${tw.ps('4')}`}
      >
