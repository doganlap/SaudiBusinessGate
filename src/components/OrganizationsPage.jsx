...
import EnhancedOrganizationForm from './EnhancedOrganizationForm';
...
const OrganizationsPage = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await databaseManagerService.deleteOrganization(id);
  ...
  const handleSave = async (formData) => {
    try {
      if (editingOrg) {
        // Update existing
        await databaseManagerService.updateOrganization(editingOrg.id, formData);
        alert('Organization updated successfully');
      } else {
        // Create new
        await databaseManagerService.createOrganization(formData);
