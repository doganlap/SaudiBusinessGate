...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Saudi Store Brand Colors - Professional Blue & Gold Theme
        brand: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Secondary Brand Colors - Gold Accent
        accent: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
      ...
      fontFamily: {
        ...
        arabic: ['var(--font-arabic)', 'Noto Sans Arabic', 'Cairo', 'Tajawal', 'system-ui', 'sans-serif'],
